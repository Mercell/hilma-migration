...
namespace Hilma.Domain.Data.Write
{
    ...
    /// <summary>AttachmentInfo for stopping TED publication</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.11.0 (Newtonsoft.Json v11.0.0.0)")]
    ...
    /// <summary>Contract for creating notices via Ets API</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.11.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class EtsNoticeContract
    {
        /// <summary>Internal identifier of created Hilma notice. Cannot be assigned on creations.
        /// This identifier can be user to generate URL to public notice in Hilma</summary>
        ...
        /// <summary>The regulation number that is used as a legal basis for the notice, for national notices this is optional</summary>
        ...
        /// <summary>List of link URLs, including protocol. Displayed in attachments section
        /// of the notice as links to external resource.</summary>
        ...
        /// in Hilma.Domain.DataContracts.EtsContracts.EtsNoticeContract.LotsInfo section, should contain exactly one description
        /// for the whole tender. If defined as partitioned in, number of objects neets to
        /// match number of lots defined in Hilma.Domain.DataContracts.EtsContracts.EtsNoticeContract.LotsInfo.</summary>
        ...
        public EtsOrganisationContract Organisation { get; set; }

        /// <summary>OJS Number for published Ted notices.
        /// Can be null.</summary>
        ...
        /// <summary>IV.2.1) Previous publication concerning this procedure
        ...
        /// will take care of filling the previous notice OJS number automatically.</summary>
        ...
        public EtsProjectContract Project { get; set; }

        /// <summary>Sales pitch for the tender to get vendors interested in making an offer.</summary>
        ...
        /// <summary>II.1.3) Type of contract
        /// Type of notice described in this dto.</summary>
        [Newtonsoft.Json.JsonProperty("type", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public EtsNoticeContractType? Type { get; set; }
        ...
        /// <summary>Language in which the notice is published. Works with FI, SV or EN</summary>
        ...
        /// <summary>If corrigenduming a notice.</summary>
        ...
        /// <summary>If the national procurement should be cancelled
        /// Provide parent id</summary>
        ...
        /// <summary>Why the national procurement has been cancelled</summary>
        ...
        /// <summary>Corrigendum notice changes are populated by Hilma.</summary>
    ...
    /// <summary>Summary of a notice posted to hilma for Ets API.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.11.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class EtsNoticeSummary
    {
        ...
        /// <summary>OJS Number for published Ted notices.</summary>
        [Newtonsoft.Json.JsonProperty("noticeOjsNumber", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string NoticeOjsNumber { get; set; }

        /// <summary>The datetime at which this notice was first sent to EtsApi.</summary>
        ...
        /// <summary>Datetime at which this notice was modified the last time.</summary>
        ...
        [Newtonsoft.Json.JsonProperty("hilmaStatus", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public EtsNoticeSummaryHilmaStatus? HilmaStatus { get; set; }

        /// <summary>The date this notice was published in Hilma, or null if it is not published yet. The most common reason for delay
        /// is legal obligation to wait for TED to publish first.</summary>
        [Newtonsoft.Json.JsonProperty("hilmaPublicationDate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset? HilmaPublicationDate { get; set; }

        /// <summary>Ets API user assigned identifier for the notice. Non-empty string that needs to be unique per subscription.</summary>
        [Newtonsoft.Json.JsonProperty("etsIdentifier", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string EtsIdentifier { get; set; }

        /// <summary>Identifier for an organisation this notice is created under. The Organisation can be created by an user in Hilma
        /// or it can be automatically created with the information provided to the Ets API.</summary>
        ...
        /// <summary>Project Id assigned to this notice. In Hilma, each notice belongs to a project. Notices regarding same purchase should
        /// be placed in the same project. Project can be set in the Ets API by supplying optional query parameter on notice creation.
        /// If not supplied, hilma will generate a new project based on the information provided.</summary>
        ...
        /// <summary>Internal identifier of created Hilma notice. 
        /// This identifier can be user to generate URL to public notice in Hilma together with project id</summary>
        [Newtonsoft.Json.JsonProperty("noticeId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("tedStatus", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public EtsNoticeSummaryTedStatus? TedStatus { get; set; }

        /// <summary>Ted-assigned identifier for this notice, or null if not published to TED or not yet sent to
        /// TED.</summary>
        ...
        /// <summary>Possible error and warning messages from TED regarding this notice. Warnings are not critical and in most cases can be
        ...
        /// to same location.</summary>
        [Newtonsoft.Json.JsonProperty("tedValidationReport", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<TedValidationReport> TedValidationReport { get; set; }

        [Newtonsoft.Json.JsonProperty("notice", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public EtsNoticeContract Notice { get; set; }


    }

    /// <summary>Information about procuring organisation.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.11.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class EtsOrganisationContract
    {
        /// <summary>Surrogate key for the department</summary>
        [Newtonsoft.Json.JsonProperty("departmentIdentifier", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// <summary>Eu classification for the organisations legal basis.</summary>
        ...
        public EtsOrganisationContractContractingAuthorityType? ContractingAuthorityType { get; set; }
        ...
        public EtsOrganisationContractContractingType? ContractingType { get; set; }

        /// <summary>Eu classification for organisations primary domain of operation.</summary>
        ...
        public EtsOrganisationContractMainActivity? MainActivity { get; set; }

        /// <summary>Eu classification for organisations primary domain of operation for utilities.</summary>
        ...
        public EtsOrganisationContractMainActivityUtilities? MainActivityUtilities { get; set; }

        /// <summary>Free text explanation if "Other" is selected for Hilma.Domain.DataContracts.EtsContracts.EtsOrganisationContract.ContractingAuthorityType</summary>
        ...
        /// <summary>Free text explanation if "Other" is selected for Hilma.Domain.DataContracts.EtsContracts.EtsOrganisationContract.MainActivity or Hilma.Domain.DataContracts.EtsContracts.EtsOrganisationContract.MainActivityUtilities</summary>
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.11.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class EtsProjectContract
    {
        [Newtonsoft.Json.JsonProperty("id", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? Id { get; set; }

        /// <summary>II.1.3) Type of contract
        /// Type of contract described by this project.</summary>
        ...
        public EtsProjectContractContractType? ContractType { get; set; }

        /// <summary>II.1.1) Reference number
        /// Optional reference number for use of the procuring organisation.</summary>
        ...
        /// <summary>II.1.1) Title
        /// Given name for the procurement described by this project.</summary>
        ...
        public EtsProjectContractProcurementCategory? ProcurementCategory { get; set; }
        ...
        /// <summary>List of involved organisations in case of joint procurement</summary>
        ...
        public EtsProjectContractDefenceWorks? DefenceWorks { get; set; }
        ...
        public EtsProjectContractDefenceSupplies? DefenceSupplies { get; set; }
        ...
        /// <summary>If defence contract award and DefenceCategory &gt; 20, this should to be set.
        /// true sets for eg. 21N
        /// false or null sets for eg. 21Y</summary>
        ...
        public EtsProjectContractAgricultureWorks? AgricultureWorks { get; set; }


    }

    /// <summary>Information about TED publication process, if successful available.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.11.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class EtsTedPublicationInfo
    {
        ...
        /// <summary>In TED, publications are grouped in certain way, this is the order number
        /// in that group, most often it is just "001"</summary>
        [Newtonsoft.Json.JsonProperty("orderNumberInSeries", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string OrderNumberInSeries { get; set; }

        /// <summary>Moment of publication in TED</summary>
        ...
        /// <summary>Moment the request for publish arrived to TED</summary>
        [Newtonsoft.Json.JsonProperty("publicationRequestedDate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset? PublicationRequestedDate { get; set; }
    ...
    /// <summary>Used when stopping TED publication
    /// Complementary information about the process</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.11.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class StopPublicationInfo
    {
        /// <summary>Complementary information about the stop publication process</summary>
        [Newtonsoft.Json.JsonProperty("description", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Description { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.11.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum EtsNoticeContractType
    {
        Undefined = 0,
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.11.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum EtsNoticeSummaryHilmaStatus
    {
        Undefined = 0,
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.11.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum EtsNoticeSummaryTedStatus
    {
        Undefined = 0,
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.11.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum EtsOrganisationContractContractingAuthorityType
    {
        Undefined = 0,
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.11.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum EtsOrganisationContractContractingType
    {
        Undefined = 0,
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.11.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum EtsOrganisationContractMainActivity
    {
        Undefined = 0,
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.11.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum EtsOrganisationContractMainActivityUtilities
    {
        Undefined = 0,
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.11.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum EtsProjectContractContractType
    {
        Undefined = 0,
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.11.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum EtsProjectContractProcurementCategory
    {
        Undefined = 0,
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.11.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum EtsProjectContractDefenceWorks
    {
        Undefined = 0,
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.11.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum EtsProjectContractDefenceSupplies
    {
        Undefined = 0,
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.11.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum EtsProjectContractAgricultureWorks
    {
        Undefined = 0,
